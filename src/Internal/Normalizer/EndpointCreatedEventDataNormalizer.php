...
class EndpointCreatedEventDataNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === 'Svix\\Internal\\Model\\EndpointCreatedEventData';
    }
    public function supportsNormalization($data, $format = null, array $context = array()) : bool
    {
        return is_object($data) && get_class($data) === 'Svix\\Internal\\Model\\EndpointCreatedEventData';
    }
    /**
     * @return mixed
     */
    public function denormalize($data, $class, $format = null, array $context = array())
    {
        ...
        $object = new \Svix\Internal\Model\EndpointCreatedEventData();
    ...
    {
        return array('Svix\\Internal\\Model\\EndpointCreatedEventData' => false);
    }
}