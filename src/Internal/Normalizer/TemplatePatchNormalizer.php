...
class TemplatePatchNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === 'Svix\\Internal\\Model\\TemplatePatch';
    }
    public function supportsNormalization($data, $format = null, array $context = array()) : bool
    {
        return is_object($data) && get_class($data) === 'Svix\\Internal\\Model\\TemplatePatch';
    }
    /**
     * @return mixed
     */
    public function denormalize($data, $class, $format = null, array $context = array())
    {
        ...
        $object = new \Svix\Internal\Model\TemplatePatch();
    ...
    public function normalize($object, $format = null, array $context = array())
    {
        ...
        if ($object->isInitialized('transformation') && null !== $object->getTransformation()) {
    ...
    {
        return array('Svix\\Internal\\Model\\TemplatePatch' => false);
    }
}