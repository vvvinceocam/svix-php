...
class ListResponseApplicationOutNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === 'Svix\\Internal\\Model\\ListResponseApplicationOut';
    }
    public function supportsNormalization($data, $format = null, array $context = array()) : bool
    {
        return is_object($data) && get_class($data) === 'Svix\\Internal\\Model\\ListResponseApplicationOut';
    }
    /**
     * @return mixed
     */
    public function denormalize($data, $class, $format = null, array $context = array())
    {
        ...
        $object = new \Svix\Internal\Model\ListResponseApplicationOut();
        ...
        if (\array_key_exists('data', $data)) {
            ...
            foreach ($data['data'] as $value) {
                $values[] = $this->denormalizer->denormalize($value, 'Svix\\Internal\\Model\\ApplicationOut', 'json', $context);
            }
    ...
    {
        return array('Svix\\Internal\\Model\\ListResponseApplicationOut' => false);
    }
}