...
class EndpointDisabledEventData extends \ArrayObject
{
    /**
     * @var array
     */
     ...
     * @return \DateTime
     */
    public function getFailSince() : \DateTime
    {
     ...
     * 
     *
     * @param \DateTime $failSince
     *
     * @return self
     */
    public function setFailSince(\DateTime $failSince) : self
    {
        $this->initialized['failSince'] = true;
