...
class V1EndpointReplay extends \Svix\Internal\Runtime\Client\BaseEndpoint implements \Svix\Internal\Runtime\Client\Endpoint
{
     ...
     * }
     */
    public function __construct(string $appId, string $endpointId, \Svix\Internal\Model\ReplayIn $requestBody, array $headerParameters = array())
    {
        $this->app_id = $appId;
    ...
    {
        return str_replace(array('{app_id}', '{endpoint_id}'), array($this->app_id, $this->endpoint_id), '/api/v1/app/{app_id}/endpoint/{endpoint_id}/replay-missing/');
    }
