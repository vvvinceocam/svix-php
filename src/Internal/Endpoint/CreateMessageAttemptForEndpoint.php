...
class CreateMessageAttemptForEndpoint extends \Svix\Internal\Runtime\Client\BaseEndpoint implements \Svix\Internal\Runtime\Client\Endpoint
{
    ...
    * }
    */
    public function __construct(string $appId, string $endpointId, \Svix\Internal\Model\MessageIn $requestBody, array $headerParameters = [])
    {
        $this->app_id = $appId;
    ...
    {
        return str_replace(['{app_id}', '{endpoint_id}'], [$this->app_id, $this->endpoint_id], '/api/v1/app/{app_id}/endpoint/{endpoint_id}/msg/test-attempt/');
    }
