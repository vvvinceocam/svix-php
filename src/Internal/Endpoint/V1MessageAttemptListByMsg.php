...
class V1MessageAttemptListByMsg extends \Svix\Internal\Runtime\Client\BaseEndpoint implements \Svix\Internal\Runtime\Client\Endpoint
{
    ...
    */
    ...
    {
        return str_replace(array('{app_id}', '{msg_id}'), array($this->app_id, $this->msg_id), '/api/v1/app/{app_id}/attempt/msg/{msg_id}/');
    }
    ...
    protected function getQueryOptionsResolver() : \Symfony\Component\OptionsResolver\OptionsResolver
    {
        ...
        $optionsResolver->setDefined(array('limit', 'iterator', 'status', 'status_code_class', 'channel', 'endpoint_id', 'before', 'after', 'with_content', 'event_types'));
