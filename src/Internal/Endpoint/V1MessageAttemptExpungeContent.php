...
class V1MessageAttemptExpungeContent extends \Svix\Internal\Runtime\Client\BaseEndpoint implements \Svix\Internal\Runtime\Client\Endpoint
{
    ...
    {
        return str_replace(array('{app_id}', '{msg_id}', '{attempt_id}'), array($this->app_id, $this->msg_id, $this->attempt_id), '/api/v1/app/{app_id}/msg/{msg_id}/attempt/{attempt_id}/content/');
    }
